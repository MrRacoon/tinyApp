...
var _user$project$Config_Types$Model = F3(
	function (a, b, c) {
		return {config: a, features: b, localization: c};
	});
var _user$project$Config_Types$LoadConfig = function (a) {
	return {ctor: 'LoadConfig', _0: a};
};

var _user$project$Config_Json$stringDictDecoder = _elm_lang$core$Json_Decode$dict(_elm_lang$core$Json_Decode$string);
var _user$project$Config_Json$modelDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$Config_Types$Model,
	A2(_elm_lang$core$Json_Decode$field, 'config', _user$project$Config_Json$stringDictDecoder),
	A2(_elm_lang$core$Json_Decode$field, 'feature_flags', _user$project$Config_Json$stringDictDecoder),
	A2(
		_elm_lang$core$Json_Decode$field,
		'localization',
		_elm_lang$core$Json_Decode$dict(_user$project$Config_Json$stringDictDecoder)));

var _user$project$Config_Rest$getConfig = A2(
	_elm_lang$http$Http$send,
	_user$project$Config_Types$LoadConfig,
	A2(_elm_lang$http$Http$get, '/config.json', _user$project$Config_Json$modelDecoder));

var _user$project$Config_State$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Config_State$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0._0.ctor === 'Ok') {
			var _p2 = _p0._0._0;
			var _p1 = A2(_elm_lang$core$Debug$log, 'error', _p2);
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_p2,
				{ctor: '[]'});
...
var _user$project$Config_State$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	A3(_user$project$Config_Types$Model, _elm_lang$core$Dict$empty, _elm_lang$core$Dict$empty, _elm_lang$core$Dict$empty),
	{
		ctor: '::',
		_0: _user$project$Config_Rest$getConfig,
		_1: {ctor: '[]'}
	});

var _user$project$Config_Utils$getLocalString = F3(
	function (name, lang, model) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			name,
			A2(
				...
				A2(
					_elm_lang$core$Maybe$withDefault,
					_elm_lang$core$Dict$empty,
					A2(_elm_lang$core$Dict$get, name, model.localization))));
	});

var _user$project$Config_View$view = function (model) {
	var pageTitle = A3(_user$project$Config_Utils$getLocalString, 'page_title', 'en', model);
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(pageTitle),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _user$project$Constants$wsPort = 8081;
var _user$project$Constants$wsHost = '127.0.0.1';
var _user$project$Constants$wsUrl = A2(
	_elm_lang$core$Basics_ops['++'],
	'ws://',
	A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$Constants$wsHost,
		A2(
			_elm_lang$core$Basics_ops['++'],
			':',
			_elm_lang$core$Basics$toString(_user$project$Constants$wsPort))));

var _user$project$Types$Model = function (a) {
	return {config: a};
};
var _user$project$Types$ServerMsg = function (a) {
	return {ctor: 'ServerMsg', _0: a};
};
var _user$project$Types$ConfigMsg = function (a) {
	return {ctor: 'ConfigMsg', _0: a};
};
var _user$project$Types$Anything = {ctor: 'Anything'};

var _user$project$State$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, _user$project$Constants$wsUrl, _user$project$Types$ServerMsg);
};
var _user$project$State$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'ConfigMsg':
				var _p1 = A2(_user$project$Config_State$update, _p0._0, model.config);
				var configState = _p1._0;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					...
					{ctor: '[]'});
			case 'ServerMsg':
				var _p2 = A2(_elm_lang$core$Debug$log, 'ServerMsg', _p0._0);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{ctor: '[]'});
...
var _user$project$State$init = function () {
	var _p3 = _user$project$Config_State$init;
	var configInit = _p3._0;
	var configCmd = _p3._1;
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{config: configInit},
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Types$ConfigMsg, configCmd),
			_1: {ctor: '[]'}
		});
}();
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				_user$project$Types$ConfigMsg,
				_user$project$Config_View$view(model.config)),
			_1: {ctor: '[]'}
		});
};
